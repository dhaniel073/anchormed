...
$printAddressBase2 = "index.php/billing/thermalviewBill/";

if ($patient["patient_number"] == NON_CUSTOMER_ID) {

    $printAddressBase = "index.php/billing/nonCustomerBill/";
	$printAddressBase2 = "index.php/billing/thermalnonCustomerBill/";
}
                    ...
                    <div class="panel-body">
                        <div class="row invoice-list">
                            <div class="text-center corporate-id">
                                ...
                                <img src="<?= base_url() ?>assets/img/logo/logo.png" alt="" height="100">
                            </div>
...
<p>
                        ...
                        <form name="postBill" id="postBill" action="<?= base_url() ?>index.php/billing/postBill"
                              method="post">
                            ...
                            <input type="hidden" name="partial_amount" id="partial_amount" value="0"/>
                            <input type="hidden" name="partial_payment_flag" id="partial_payment_flag" value="N"/>
                            <input type="hidden" name="offset_from_deposit_flag" id="offset_from_deposit_flag" />
							
				 <input type="hidden" name="payment_mode_type" id="payment_mode_type"/>

                            <input type="hidden" name="hmo_split_flag" id="hmo_split_flag" type="hidden"
                                   value="N"/>

                            <input type="hidden" name="hmo_patient_split_amount" id="hmo_patient_split_amount" value="0"/>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <?php if($mode != "print" && $allow_editable_bills == "true"){ ?>
                                    <th>&nbsp;</th>
                                    <?php } ?>
                                </tr>
                                </thead>
                                ...
                                foreach ($current_bill as $item) {
                                    ...
                                    <tr>
                                        <?php if (isset($partial_payment_data)) { ?>
                                            ...
                                            <input type="hidden" name="bill[]" value="<?php echo $item['id']; ?>"/>
                                        <?php } else { ?>
                                           
										   <?php if ($checkvalue==1) { ?>
											<td><input class="bill-item" name="bill[]" type="checkbox" checked="unchecked"
																			   value="<?php echo $item['id']; ?>"/></td>
											<?php } else { ?>
											<td><input class="bill-item" name="bill[]" type="checkbox" 
																			   value="<?php echo $item['id']; ?>"/></td>
                                        ...
                                        <td class="hidden-phone"><?php echo ucwords($item['service_name']); ?></td>

                                        <?php if(!$isSecurityDeposit){ if($showUnitPrice){ ?>
                                            <td class=""><?php echo $currencySymbol; echo number_format((float)$item['unit_price'],2,'.','');
                                               // echo money_format('%(#10n', $item['unit_price']); ?></td>
                                        <?php }
                                            ...
                                            <?php if($isSecurityDeposit){
                                                ...
                                                echo "<td class=\"\">";
                                                echo $currencySymbol;
                                                echo number_format((float)$item['qty'],2,'.','');
                                                echo "</td>";

                                            }else{

                                                if($show_item_quantity){
                                        ...
                                        <?php if($mode != "print" && $can_edit_bill_item && $allow_editable_bills == "true"){ ?>
                                        <td><a data-toggle="modal" bill_id="<?php echo $item["id"]; ?>" class="update_item_price" href="#customItemAmount"><i class="fa fa-pencil-square-o fa-2x"></i></a></td>
						...
						<tr><td><a href="<?= base_url() ?>index.php/billing/currentBill/<?php echo $patient['patient_number']; ?>/1" ><b>Check</b></a>&nbsp;/&nbsp;<a href="<?= base_url() ?>index.php/billing/currentBill/<?php echo $patient['patient_number']; ?>/2" ><b>Uncheck</b></a></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
                                </tbody>
                            </table>
                        </form>
                        ...
                        <div class="row" style="margin-top:40px;">
                            <div class="col-lg-4 invoice-block pull-right">
                                <ul class="unstyled amounts">
                                    <li><strong>Sub - Total amount :
                                        <?php echo $currencySymbol; ?> <?php
                                            echo number_format((float)$grandTotal,2,'.','');
                                        ?></strong></li>
                                    <li><strong>Grand Total : <?php echo $currencySymbol; ?>
                                        <?php
                                        echo number_format((float)$grandTotal,2,'.','');
                                        //echo money_format('%(#10n', $grandTotal); ?>
                                        </strong></li>
                                    <?php if (isset($partial_payment_data)) { ?>
                                        <li><strong>Total Paid :
                                           <?php echo $currencySymbol; ?> <?php
                                            echo number_format((float)$totalPaidSofar,2,'.','');
                                            //money_format('%(#10n', $totalPaidSofar);
                                            ?></strong></li>
                                        <li><strong>Amount Due :
                                            <?php echo $currencySymbol; ?>
                                            <?php
                                            echo number_format((float)($grandTotal - $totalPaidSofar),2,'.','');
                                            ?></strong></li>
                                   <?php }else{ ?>
									
										<?php if (isset($partial_current_bill)) { ?>
											<li><strong>Amount Due :
													<?php echo $currencySymbol; ?>
													<?php
													echo number_format((float)($grandTotal - $partial_current_bill["amount_paid"]),2,'.','');
													?></strong></li>
                        ...
                        <div class="text-center invoice-btn">
                            ...
                            if ($mode != 'print') {
                                ...
                                <a href="<?= base_url() ?><?php echo $printAddressBase . $reference;?>?print_mode=true"
								 ...
								 <a href="<?= base_url() ?><?php echo $printAddressBase2 . $reference;?>?print_mode=true"
                                   target="_blank" class="btn btn-info btn-lg"><i class="fa fa-print"></i> Print Thermal </a>
                    ...
                    <div class="modal-body">
                        ...
                        <script type="application/x-javascript">
                            ...
                            function splitBill(){
								...
								//var paymentMode = $("input#payment_mode").val();
                                ...
                                if(isValidSplit){
									...
									$("input#payment_mode_type").val(paymentMode);
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
                    ...
                    <input type="text" class="form-control" name="custom_quantity" id="custom_quantity"
                           value=""/>
                ...
                <script type="application/x-javascript">
                    ...
                    function updateItemPrice(){
                       // alert("item price updated");
						...
						if($.isNumeric($("input#custom_quantity").val())){
            ...
            <div class="modal-body">
                ...
                <script type="application/x-javascript">
                    ...
                    function validateSecurityOffSet(){
                        ...
                        }else if(securityDeposit < billAmount){
							postBill = true;
                            $("input#offset_from_deposit_flag").val("Y");
							$("input#partial_payment_flag").val("Y");
							$("input#partial_amount").val(securityDeposit);
                            console.log("valid bill amount, patial payment");
                    ...
                    function validateAmountBeingPaid() {
                        ...
                        else if (recievedAmount < 0 || recievedAmount > billAmount) {
