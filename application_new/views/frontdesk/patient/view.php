...
<th>Status</th>
    ...
    <?php foreach($financialdetail as $financialdetails){?>
		<tr class="referral_report" id="<?php echo $financialdetails['id']; ?>">
			<td><?php echo $financialdetails['date_created']; ?></td>
			<td><?php echo $financialdetails['reference_id']; ?></td>
			<td><?php echo $financialdetails['description']; ?></td>
			<td><?php echo $financialdetails['qty']; ?></td>
			<td><?php if(isset($financialdetails['selling_price'])) { echo $financialdetails['selling_price']; } else { echo ($financialdetails['unit_price'] * $financialdetails['qty']); } ?></td>
