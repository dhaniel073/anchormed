...
<header class="panel-heading">
    <?php echo ucfirst($sampletype['name']); ?>
    ...
    <div class="panel-body" style="margin-top:10px; min-height: 400px;">
          ...
          <div style="float:left; margin: 20px; width:60%;">
           ...
           <div class="form-group">
                ...
                <div class="col-lg-10"> 
                <input name="name" disabled="disabled" value="<?php  if(isset($sampletype['name']))echo $sampletype['name']; ?>" id="name" type="text" class="form-control" placeholder="Name">
                <br/>
                </div>
            </div>
           ...
           <form name="updateform" id="updateform" action="<?=base_url()?>index.php/laboratory/updateSample" method="post">            
          
           <input name="sampletype" value="<?php echo $sampletype["sample_type_id"]; ?>" type="hidden"/>
           
             <div class="form-group" >
            
                <label class="col-lg-2 control-label" style="top:+10px;">Description</label>
                <div class="col-lg-10"> 
                <input editable="yes" name="description" disabled="disabled" value="<?php  if(isset($sampletype['description']))echo $sampletype['description']; ?>" id="description" type="text" class="form-control" placeholder="Description">
                <br/>
                </div>
            </div>
             ...
             <script>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                   ...
                   <a  id="link_delete" href="#"  helper="bill_helper" style="font:20px" class="has-helper btn btn-shadow btn-md btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                        
                        <span class="helper-span" style="color: #FC0022;" id="bill_helper"> Delete Sample Type</span>
                   <br/>
                </div>
...
<form name="deleteTest" id="deleteTest" method="POST" action="<?=base_url()?>index.php/laboratory/deleteSampleType">
                <input name="sampletype" value="<?php echo $sampletype["sample_type_id"]; ?>" type="hidden"/>
</form>
