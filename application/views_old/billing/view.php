                    ...
                    <div class="panel-body">
                        <div class="row invoice-list">
                            ...
                            <div class="col-lg-4 col-sm-4">
								...
								<p>
                                    HMO Code : <?php if (isset($patient['hmo_code'])) echo ucwords($patient['hmo_code'] . " "); ?> <br>
                                </p>
								<p>
                                    HMO Name : <?php if (isset($hmo_name['hmo_name'])) echo $hmo_name['hmo_name']; ?> <br>
                                </p>
								<p>
                                    HMO No : <?php if (isset($patient['hmo_enrolee_id'])) echo ucwords($patient['hmo_enrolee_id'] . " "); ?> <br>
                                </p>
                            </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                foreach ($current_bill as $item) {
                                    ...
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                            <td><input class="bill-item" name="bill[]" type="checkbox" checked="checked"
