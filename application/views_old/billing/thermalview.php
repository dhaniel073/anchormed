                    ...
                    <div class="panel-body">
                        <div class="row invoice-list">
                            ...
                            <div class="col-lg-4 col-sm-4">
                                ...
                                <p>
                                    Patient Name: <?php if (isset($patient['first_name'])) echo ucwords($patient['first_name'] . " ");
                                    if (isset($patient['last_name'])) echo($patient['last_name']); ?> <br>
									File Type:<?php if (isset($patient['patient_type_code'])) echo ucwords($patient['patient_type_code'] . " "); ?> <br>
									<?php if (isset($patient['hmo_code'])) echo 'HMO CODE: '.ucwords($patient['hmo_code'] . " "); echo '<br>'; ?> 
									<?php if (isset($patient['hmo_enrolee_id'])) echo 'HMO Enrollee No.: '.ucwords($patient['hmo_enrolee_id'] . " "); echo '<br>'; ?> 
								...
								<p>
                                    Date of Transaction : <?php echo $trandate; ?> <br>
                                </p>
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <?php } ?>
                                ...
                                foreach ($current_bill as $item) {
                                    ...
                                    <tr>
                                        <br />
                                        <td class="hidden-phone"><b>SN: </b><?php echo $counter; ?><b><br />Item Name:</b> <?php echo ucwords($item['service_name']); ?><br />
										<b>Unit Cost:</b>
										<?php echo $currencySymbol; echo number_format((float)$item['unit_price'],2,'.',''); ?>  <br />
							...
							<ul class="unstyled amounts">
									...
									<?php if (isset($payment_hmo_bill)) { ?>
									<hr>
									<p><b>Customers Payment Allocation:</b> <?php echo $payment_hmo_bill["amount_paid"]?></p>
									<p><b>HMO Payment Allocation:</b> <?php echo (($grandTotal - $totalPaidSofar) - $payment_hmo_bill["amount_paid"]) ?></p>
									<hr>
