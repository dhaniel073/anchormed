...
<tr class="gradeX">
  ...
  <?php
        ...
        ?>  
<td><a href="<?=base_url()?>index.php/patient/number/<?php echo $patient['patient_number']; ?>" target="_blank"><?php echo $patient['patient_number']; ?></a></td>
<?php }?>
...
<td><?php echo $patient["date_discharged"];?></td>
