...
<!-- < ?php print_r($current_patient) ?> -->

			<?php if(isset($current_patient)){ ?>
                     <input type="hidden" name="patient_family_id_new"  value="<?php echo $current_patient['patient_family_id']; ?>"/>
 ...
 <div class="form-group">
	<label class="label_check" for="checkbox-01">
		...
		<div id="examination_div" class="more_details">
			<label class="label_check" for="checkbox-01">General Examination</label>
			<input name="examination_action" id="examination_div_text"  class="form-control"  type="text"  /> 
			
					
			<label class="label_check" for="checkbox-01">Head and Neck</label>
			<textarea name="examination_head_neck"  id="examination_head_neck_div" class="form-control" rows="4" cols="100"></textarea>
			
			<label class="label_check" for="checkbox-01">Upper Limp</label> 
			<textarea name="examination_upper_limp"  id="examination_upper_limp_div" class="form-control"></textarea>
			
			<label class="label_check" for="checkbox-01">Abdomen</label>
			<textarea name="examination_abdomen"  id="examination_abdomen_div" class="form-control"></textarea>
			
			<label class="label_check" for="checkbox-01">VE</label>
			<textarea name="examination_ve"  id="examination_ve_div" class="form-control"></textarea>
			
			<label class="label_check" for="checkbox-01">PR</label>
			<textarea name="examination_pr"  id="examination_pr_div" class="form-control"></textarea>
...
<div class="form-group">
 ...
 <form action="#" class="form-horizontal tasi-form">
    <?php if(isset($family_member)){ ?>
                     <input type="hidden" name="patient_family_id"  value="<?php echo $family_member['patient_family_id']; ?>"/>
...
<script>
     ...
     function getAdmissionList() {
		...
		try{
            ...
            $("tbody#order_body").append("<tr><td><a class='single_order' onclick='javascript:performTest(\""+obj[i]['patient_history_id']+"\",\""+obj[i]['id']+"\")' href='#'>"+obj[i]['first_name']+" "+obj[i]['last_name']+"</a></td><td>"+obj[i]['date_created']+"</td><td>"+obj[i]['ordered_by']+"</td><td>"+obj[i]['hmo_code']+"</td><td>"+obj[i]['hmo_name']+"</td></tr>");
...
<script>
    ...
    function getAdmittedPatients() {
		...
		try{
            ...
            $("tbody#admitted_patient").append("<tr><td><a href='<?=base_url()?>index.php/patient/number/"+obj[i]['patient_number']+"'>"+obj[i]['patient_number']+"</a></td><td>"+obj[i]['patient']['first_name']+" "+obj[i]['patient']['middle_name']+" "+obj[i]['patient']['last_name']+"</td><td>"+obj[i]['admitted_by']+"</td><td>"+obj[i]['ward_name']+"</td><td>"+obj[i]['hmo_code']+"</td><td>"+obj[i]['hmo_name']+"</td></tr>");
