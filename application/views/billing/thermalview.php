...
?>
                                ...
                                <p>
                                    ...
                                    Patient Type :  <?php if (isset($patient['patient_type_code'])) if($patient['patient_type_code']=='S') echo 'Standard'; elseif($patient['patient_type_code']=='H') echo 'Health Insurance'; elseif($patient['patient_type_code']=='F') echo 'Family'; else echo 'WALKIN'; ?> <br>
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <?php } ?>
                                ...
                                foreach ($current_bill as $item) {
									...
									<?php }?>
									<?php if(isset($patient['patient_type_code'])&&(($patient['patient_type_code']=='S') OR ($patient['patient_type_code']=='F'))) { ?>
									...
									?>
									<?php }else{ echo 'Total Amount: '.$grandTotal;}?>
									<p></p>
									</br>
									</br>
