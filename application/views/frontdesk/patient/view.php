...
<li>
<a href="<?=base_url()?>index.php/laboratory/viewPatientTests/<?php echo $patient["patient_number"];?>" target="_blank" data-toggle="modal">
...
<?php if($patient['patient_type_code'] == "H"){ ?>
    ...
    <li>
        <a href="<?=base_url()?>index.php/provider/view/<?php echo $patient['hmo_code']?>" target="_blank">
...
<?php if($patient['file_lock'] == "Y"){ ?>
    ...
    <li>
		...
		<?php if($user_role["role_id"]==3){?>
		<a href="<?=base_url()?>index.php/patient/unlockfile/<?php echo $patient["patient_number"];?>" data-toggle="modal">
		<?php } ?>
        <i class="fa fa-check-square text-success"></i>
                Unlock| Date locked: ( <?php echo $patient['file_lock_date']; ?> )
        <?php if($user_role["role_id"]==3){?>
		</a>
		<?php } ?>
    </li>
...
<?php }else{?>
	<li>
		<?php if($user_role["role_id"]==3){?>
       <a href="<?=base_url()?>index.php/patient/lockfile/<?php echo $patient["patient_number"];?>" data-toggle="modal">
	   <?php } ?>
        <i class="fa fa-check-square text-success"></i>
                Lock| Date unlocked: ( <?php echo $patient['file_unlock_date']; ?> )
		<?php if($user_role["role_id"]==3){?>
        </a>
		<?php } ?>
    </li>
...
<form name="workbenchTransForm" id="workbenchTransForm" method="post" action="<?=base_url()?>index.php/workbench/forceTakeUpPatient">
    <input type="hidden" value="<?php echo $patient["patient_number"] ?>" name="patient_number"/>
	 ...
	 <?php if(isset($patient_family_id)){?>
		<input name="patient_family_id" type="hidden" value="<?php echo $patient_family_id_new ?>"/>
...
<aside class="profile-info col-lg-12">
    ...
    <section class="panel">
       ...
       <?php if(($patient['free_code_1']) == null) { ?>
                    <h3>
                    File Type: <?php echo ucfirst('Not set')?>
                    </h3>  
                <?php } else{?>
                <h3>
                File Type: 
                <?php if(isset($patient['free_code_1'])) echo ucfirst($freecode1["name"])?>
                </h3>
                <?php }?>
       ...
       <hr/>
        <div class="row">
		<div class="bio-row">
        <p><span>Reg Date </span>: <?php echo $patient['date_created'];?></p>
        </div>
        <div class="bio-row">
		...
		<?php if(isset($patient['hmo_code'])){ ?>
		<div class="bio-row">
        <p><span>HMO </span>: <?php if(isset($patient['hmo_code']))  echo ucfirst($patient['hmo_code']);?></p>
        </div>
		<div class="bio-row">
        <p><span>HMO Enrolle ID </span>: <?php if(isset($patient['hmo_enrolee_id']))  echo ucfirst($patient['hmo_enrolee_id']);?></p>
        </div>
			<?php if(isset($patient['primary_enrollee_id'])){ ?>
				<div class="bio-row">
				<a href="<?=base_url()?>index.php/patient/number/<?php echo $pri_enrollee['patient_number']; ?>" target="_blank"><p><span>Pri Enrollee ID </span>: <?php if(isset($patient['primary_enrollee_id']))  echo ucfirst($patient['primary_enrollee_id']);?></p></a>
				</div>
			<?php }else{ ?>
				<a href="#myModalHMODependents" data-toggle="modal" class="btn btn-xs btn-success" style="margin: 5px;">
				View HMO Dependents
				</a>					
			<?php } ?>
		<?php } ?>
		...
		<a target="_blank" href="<?=base_url()?>index.php/patient/legacyreport/<?php echo $patient['patient_number']?>" data-toggle="modal" class="btn btn-xs btn-success" style="margin: 5px;">
       ...
       <!-- Refer Patient-->
		...
		<a href="#myModal29" data-toggle="modal" class="btn btn-xs btn-success" style="margin: 5px;">
        Admission Details
        </a>
		
		<a href="#myModal30" data-toggle="modal" class="btn btn-xs btn-success" style="margin: 5px;">
        Financial Records
        </a>
		
		<a href="#myModal31" data-toggle="modal" class="btn btn-xs btn-success" style="margin: 5px;">
        Nurse Actions
        </a>
   ...
   <button type="submit" id="update_physic" class="btn btn-default" onclick="javascript:updatePhysic();">Update</button>
    ...
    <div id="hmo" class="tab-pane">
        ...
        <form name="updateHmo" method="post" action="<?= base_url() ?>index.php/patient/updateHmo">
			...
			<div class="form-group">
                <label for="exampleInputEmail1">Primary Enrolle ID</label>
                <input type="text" class="form-control" value="<?php echo ($patient['primary_enrollee_id']); ?>"
                       name="pri_enrolee_id" id="pri_enrolee_id" placeholder="Primary ENROLLEE ID">
                <input type="hidden" name="patient_number" value="<?php echo $patient['patient_number'];?>"/>

            </div>	

			<div class="form-group">
				<label for="exampleInputEmail1">Relationship to Primary</label>
				<select name="rel_to_primary_enrollee" id="rel_to_primary_enrollee" class="form-control m-bot15">
						<option value="<?php echo $patient['rel_to_primary_enrolle']; ?>"><?php echo $curr_relationship['relationship_name']; ?></option>
						<?php
...
<form name="uploadpatientpicwebcam" method="POST" action="<?=base_url()?>index.php/patient/uploadPatientPicWebcam">
<input type="hidden" id="patient_number" value="<?php echo $patient['patient_number'];?>" name="patient_number"/>
 <?php if(isset($family_member)){ ?>
 <input type="hidden" value="<?php echo $family_member['patient_family_id'];?>" name="patient_family_id"/>
   <?php } ?>
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <br/>
                <button class="btn btn-success" onclick="javascript:uploadPicWebcam();">Submit</button>
            </div>
        </div>
    </form>
 ...
 <script>
	...
	function uploadPicWebcam() {
        //code
       $("form[name=uploadpatientpicwebcam]").submit();
    }
 </script>
</div>
</div>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalHMODependents" class="modal fade">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
<button aria-hidden="true" data-dismiss="modal" class="close" type="button">&#10006;</button>
<h4 class="modal-title">HMO Dependents</div>
<div class="modal-body">
...
<th>Enrollee ID</th>
    ...
    <input type="hidden" id="patient_number" value="<?php echo $patient['patient_number'];?>" name="patient_number"/>
		...
		<?php if(isset($pri_enrollee_dependent)){ foreach($pri_enrollee_dependent as $prienrolleedep){?>
			<tr>
				<td><a href="<?=base_url()?>index.php/patient/number/<?php echo $prienrolleedep['patient_number']; ?>" target="_blank"><?php echo $prienrolleedep['patient_number']; ?></a></td>
				<td><?php echo $prienrolleedep['last_name'].' '.$prienrolleedep['first_name'].' '.$prienrolleedep['middle_name']; ?></td>
				<td><?php echo $prienrolleedep['hmo_enrolee_id']; ?></td>
       ...
       $("tr.delivery_report").css("cursor","pointer").click(function(){
		...
		try{
			...
			//alert( obj['0']['date_created']);
						$("span#delivery_id_date").html(obj['0']['delivery_id']);
						...
						$("div#delivery_id_time").html(obj['0']['date_created']);
                        ...
                        $("div#parity").html(obj['0']['parity']);
						$("div#abnormality").html(obj['0']['abnormality']);
						$("div#state_of_perineum").html(obj['0']['state_of_perineum']);
						$("div#length").html(obj['0']['length']);
						$("div#head_circumference").html(obj['0']['head_circumference']);
						$("div#estimated_blood_loss").html(obj['0']['estimated_blood_loss']);
						$("div#presentation").html(obj['0']['presentation']);
						$("div#delivered_by").html(obj['0']['delivered_by']);
						$("div#other_findings").html(obj['0']['other_findings']);
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal29" class="modal fade">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
<button aria-hidden="true" data-dismiss="modal" class="close" type="button">&#10006;</button>
<h4 class="modal-title">View Admission Details</div>
<div class="modal-body">
...
<th>Date Discharged</th>
    ...
    <?php foreach($admissiondetail as $admissiondetails){?>
		<tr class="admission_report" id="<?php echo $admissiondetails['id']; ?>">
			<td><?php echo $admissiondetails['date_admitted']; ?></td>
			<td><?php echo $admissiondetails['ward_id']; ?></td>
			<td><?php echo $admissiondetails['bed_id']; ?></td>
			<td><?php foreach($doctors as $doctor){ if($admissiondetails['doctor_code'] == $doctor['staff_no']){echo ucfirst($doctor['first_name'])." ".ucfirst($doctor['last_name']); break;}} ?></td>
			<td><?php echo $admissiondetails['date_discharged']; ?></td>
		</tr>
     <?php }?>
...
<div class="modal-header">
<button aria-hidden="true" data-dismiss="modal" class="close" type="button">&#10006;</button>
<h4 class="modal-title">View Finanacial records</div>
<div class="modal-body">
<div><b>Unadjusted Deposit: </b><?php echo $unadjusteddeposit; ?>| <b>Total unpaid bill:</b> <?php echo $unpaidbills; ?></div>
<table class="table table-hover">
<thead>
<tr>
<th>Date created</th>
...
<th>Status</th>
    ...
    <?php foreach($financialdetail as $financialdetails){?>
		<tr class="financial_report" id="<?php echo $financialdetails['reference_id']; ?>">
		
			<td><a target="_blank" href="<?php if($financialdetails['status'] != "R"){?><?=base_url()?>index.php/billing/viewBill/<?php echo $financialdetails['reference_id']."/1";} else  {?> <?=base_url()?>index.php/billing/partialPaymentUpdate/<?php echo $financialdetails['reference_id']."/1"; }?>"><?php echo $financialdetails['date_created']; ?></a></td>
			
			<td><?php echo $financialdetails['reference_id']; ?></td>
			<td><?php echo $financialdetails['total_price']; ?></td>
			<td><?php echo $financialdetails['status']; ?></td>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal31" class="modal fade">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
<button aria-hidden="true" data-dismiss="modal" class="close" type="button">&#10006;</button>
<h4 class="modal-title">View Nurse Actions</div>
<div class="modal-body">
...
<th>Status</th>
    ...
    <?php foreach($nurseaction as $nurseactions){?>
		<tr class="referral_report" id="<?php echo $nurseactions['id']; ?>">
			<td><?php echo $nurseactions['date_created']; ?></td>
			<td><?php echo $nurseactions['task_id']; ?></td>
			<td><?php echo $nurseactions['task_specific_instructions']; ?></td>
			<td><?php foreach($staffs as $staff){ if($nurseactions['created_by'] == $staff['staff_no']){echo ucfirst($staff['first_name'])." ".ucfirst($staff['last_name']); break;}} ?></td>
			<td><?php foreach($staffs as $staff){ if($nurseactions['carried_out_by'] == $staff['staff_no']){echo ucfirst($staff['first_name'])." ".ucfirst($staff['last_name']); break;}} ?></td>
			<td><?php echo $nurseactions['carried_out_on']; ?></td>
			<td><?php echo $nurseactions['status']; ?></td>
...
<input type="text" class="form-control" name="parity" id="parity" placeholder="Parity">
<br/>
</div>

<div class="form-group">
<label for="exampleInputEmail1">Abnormality</label>
<input type="text" class="form-control" name="abnormality" id="abnormality" placeholder="Abnormality">
<br/>
</div>

<div class="form-group">
<label for="exampleInputEmail1">State Of Perineum</label>
<input type="text" class="form-control" name="state_of_perineum" id="state_of_perineum" placeholder="State Of Perineum">
<br/>
</div>
...
<div class="form-group">
<label for="exampleInputEmail1">Head Circumference</label>
<input type="text" class="form-control" name="head_circumference" id="head_circumference" placeholder="Head Circumference">
<br/>
</div>

<div class="form-group">
<label for="exampleInputEmail1">Estimated Blood Loss</label>
<input type="text" class="form-control" name="estimated_blood_loss" id="estiamted_blood_loss" placeholder="Estimated Blood Loss">
<br/>
</div>

<div class="form-group">
<label for="exampleInputEmail1">Presentation</label>
<input type="text" class="form-control" name="presentation" id="presentation" placeholder=" Presentation ">
<br/>
</div>

<div class="form-group">
<label for="exampleInputEmail1">Delivered By </label>
<input type="text" class="form-control" name="delivered_by" id="delivered_by" placeholder=" Delivered By">
<br/>
</div>

<div class="form-group">
<label for="exampleInputEmail1">Other Findings</label>
<input type="text" class="form-control" name="other_findings" id="other_findings" placeholder=" Other Findings ">
<br/>
</div>
...
<div class="form-group">
<label><strong>Parity</strong></label>

<div  name="parity" id="parity" >
</div>

</div>

<div class="form-group">
<label><strong>Abnormmality</strong></label>

<div  name="abnormality" id="abnormality" >
</div>

</div>

<div class="form-group">
<label><strong>State Of Perineum</strong></label>

<div  name="state_of_perineum" id="state_of_perineum" >
</div>
...
<div  name="head_circumference" id="head_circumference" >
</div>

</div>

<div class="form-group">
<label><strong>Estimated Blood Loss</strong></label>

<div  name="estimated_blood_loss" id="estimated_blood_loss" >
</div>
...
<div  name="presentation" id="presentation" >
</div>
...
<div  name="delivered_by" id="delivered_by" >
</div>

</div>

<div class="form-group">
<label><strong>Other Findings</strong></label>

<div  name="other_findings" id="other_findings" >
</div>
...
<footer class="twt-footer">
     ...
     <button class="btn btn-space btn-info" type="button">
           <a target="_blank" href="<?=base_url()?>index.php/patient/viewall/<?php echo $patient['patient_number']?>"> View All Previous visits</a>
        </button>
</footer>
</section>
