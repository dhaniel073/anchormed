...
class Reports extends CI_Controller
{
    ...
    private function prepareQuery($requiredPrams, $values, $query)
    {
        ...
        if (sizeof($requiredPrams) > 0 && $requiredPrams[0] != "") {
    ...
    private function execute_report($request, $report, $requiredPrams)
    {
        ...
        foreach ($query->result() as $row) {
            ...
            if ($counter == 0) {
				...
				//print_r(array_keys($reportHeaders[$counter]));
            }
    ...
    {
        log_message("debug", "got here create report process");
        ...
        log_message("debug", "about executing report");
