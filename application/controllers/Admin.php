...
class Admin extends CI_Controller {
	...
	public function disenableUser(){
		...
		//where 0 is disenable
        $data['account_status'] = 'D';
        $table_name = "ult";
        $id = "staff_no";
        $id_value = $staff["staff_no"];
        $this->general_update_model->update($table_name,$id,$id_value, $data);
		...
		$table = "staff_master";
        $this->general_update_model->update($table,$id,$id_value, $data);
        $this->utilities->redirectWithNotice("admin", "User Successfully Disabled");
	...
	public function enableUser(){
        ...
        $this->utilities->redirectWithNotice("admin", "User Successfully Enabled");
