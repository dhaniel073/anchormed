...
class Login extends CI_Controller {
	...
	public function signin()
	{
		...
		else
		{
			...
			if($isPwdCorrect )
			{
				$data['acct'] = $this->ult->getAcctStat($userName);
				// var_dump($data['acct']['account_status']);

				if($data['acct']['account_status'] === 'D'){

					$status = array("STATUS"=>"false","ERROR"=>"User Disabled");
				}
				else{
