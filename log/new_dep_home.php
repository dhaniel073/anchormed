...
<?php }?>
<?php if($role == "5"){?>
<li><a  href="#current_orders" id="get_referal_orders" data-toggle="modal"> <i class="fa fa-list-alt fa-5x"></i>Referal Order Management<span id="order_count" class="label label-danger pull-right r-activity">0</span></a></li>
<?php }?>
...
<div class="bio-row">
<p><span>Patient Number </span>: <?php if(isset($current_patient['patient_number'])) echo $current_patient['patient_number'];?></p>
</div>
<div class="bio-row">
...
<div class="bio-row">
<p><span>Patient Number </span>: <?php if(isset($action_patient['patient_number'])) echo $action_patient['patient_number'];?></p>
</div>
<div class="bio-row">
...
<div class="alert alert-success alert-block fade in" style="padding:40px;">
	...
	<?php if(($referalID[0]['id'])&&($action_type == "referal")){ ?>
